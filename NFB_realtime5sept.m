...
feedback_dir = ['C:\Users\s00388457\Desktop\new codes\NFB']; %Needs Change
...
% Load Images & Instructions
    ...
    [block_start,block_end,block_dur,block_start_TR,block_end_TR,block_start_TBV_TR,block_end_TBV_TR] = DrawFixationCross(grey,rest_dur_TR,feedback_dir,feedback_file_name);  %dark grey
